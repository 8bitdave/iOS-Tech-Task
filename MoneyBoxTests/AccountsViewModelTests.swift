...
final class AccountsViewModelTests: XCTestCase {
    ...
    let mockUser = Bundle.test.decode(Networking.LoginResponse.User.self, from: "User.json")
    ...
    func test_viewModel_fetchSuccess() {
        ...
        let mockResponse: Networking.AccountResponse = Bundle.test.decode(Networking.AccountResponse.self, from: "Accounts.json")
    ...
    func test_viewModel_fetchError_noInvestorID() {
        ...
        // Mock
        let mockProvider = MockDataProvider()
        let mockResponse: Networking.AccountResponse = Bundle.test.decode(Networking.AccountResponse.self, from: "Accounts_Error_InvestorID.json")
        mockProvider.mockFetchAccountsResponse = mockResponse
